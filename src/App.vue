...
const memories = [
  {src:'/morha-portrait.jpg',caption:'The smile that lights up every moment',date:'Morha · 22'},
  {src:'/morha-paris.png',caption:'Paris looked better with you in it',date:'A Paris memory'},
  {src:'/morha-birthday-22.png',caption:'The moment chapter 22 began',date:'Birthday · 22'},
  {src:'/morha-cake-22.png',caption:'A wish made especially for you',date:'Twenty-two wishes'},
  {src:'/morha-garden.png',caption:'Blooming wherever life takes you',date:'A beautiful day'},
  {src:'/morha-blue-evening.png',caption:'Elegance in every shade',date:'An evening to remember'},
  {src:'/morha-wish-22.png',caption:'One candle closer to every dream',date:'Chapter 22'}]
